...
async function baseCalculatePrice(req:TransectionRequest, answer:TransectionResult): Promise<TransectionResult> {
...
export async function calculatePrice(req:TransectionRequest): Promise<TransectionResult> {
